...
HD_PWD='J:/work/projects/versal/ledblink/hardware/ledblink.runs/design_1_MyLEDIP_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_MyLEDIP_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_MyLEDIP_0_4.tcl
