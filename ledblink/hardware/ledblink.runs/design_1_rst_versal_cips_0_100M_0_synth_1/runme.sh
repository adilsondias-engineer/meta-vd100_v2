...
HD_PWD='J:/work/projects/versal/ledblink/ledblink.runs/design_1_rst_versal_cips_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_versal_cips_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_versal_cips_0_100M_0.tcl
