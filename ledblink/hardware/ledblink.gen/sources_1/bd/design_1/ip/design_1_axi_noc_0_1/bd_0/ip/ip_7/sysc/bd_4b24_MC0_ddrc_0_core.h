...
//
//**********************************************************************
#ifndef bd_4b24_MC0_ddrc_0_core_h_
#define bd_4b24_MC0_ddrc_0_core_h_

#include "NOCDdrMcXtlm.h"
#include "properties.h"

class bd_4b24_MC0_ddrc_0_core : public NOCDdrMcXtlm
{
public:
  bd_4b24_MC0_ddrc_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  : NOCDdrMcXtlm(nm, props)
  {
  }

  virtual ~bd_4b24_MC0_ddrc_0_core()
  {
  }
...
public:  // stub pin-to-pin RTL interface
  ...
  sc_core::sc_out<sc_bv<1> >ch0_ddr4_bg;
